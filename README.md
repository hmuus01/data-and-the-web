...
| 12 : Passwords are stored as hashes|Passwords are hashed on registration using the passlib.hash library and sha256_crypt|`app.py`<br/> [`Line 12`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L12) [`Line 187`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L187)|✔|
| 13 : There is a way to logout|I have implemented a logout method which clears the session and redirects the user to the login page|`app.py` [`Line 263-269`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L263)|✔|
