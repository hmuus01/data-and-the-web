...
| 2 : There is more than one route and more than one view |I have used multiple routes in my web application some examples include @app.route(‘/’), @app.route(‘about’), @app.route(‘find’) etc.|`app.py`, <br/> [`Line 108`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L108) <br/> [`Line113`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L113) <br/> [`Line137`](https://gitlab.doc.gold.ac.uk/hmuus001/term-2-lab/blob/master/myApp/app.py#L137)|✔|
